//
//  EHFlexibleWidthItemsSequentialSelectionView.m
//  WFEDemo
//
...
@interface EHFlexibleWidthItemsSequentialSelectionView ()

@property (nonatomic, assign, readwrite) NSInteger selectedIndex;

@end

@implementation EHFlexibleWidthItemsSequentialSelectionView
